...
{
    const char* pszTimestamp = "Captain America was the first winter soldier but not gone rogue, Im writing this at APR 17 2021 3:14 PM";
    const CScript genesisOutputScript = CScript() << ParseHex("886884710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b0800") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1618652902, 2000057305, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5c945ddba1981250fafe24c4ed30dc8c04a4f17088b3a69c2ad7267cd83fca43"));
        assert(genesis.hashMerkleRoot == uint256S("0x8040f3414db8ed4aee9bde4fb9ce56e27c63ab9f43efdbef036aaef13734963a"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("ohcoin.in", "ohcoin.in", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("ohcointools.com", "dnsseed.ohcointools.com"));
        // vSeeds.push_back(CDNSSeedData("ohcoinpool.org", "dnsseed.ohcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x5c945ddba1981250fafe24c4ed30dc8c04a4f17088b3a69c2ad7267cd83fca43"))
        ...
        chainTxData = ChainTxData{
            ...
            1618652902, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1618652902, 300408, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe9132d581856b5080a3936ba9e3494e984bac66b7bc2360c2a0aeab9d825cce6"));
        assert(genesis.hashMerkleRoot == uint256S("0x8040f3414db8ed4aee9bde4fb9ce56e27c63ab9f43efdbef036aaef13734963a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("ohcoin.in", "ohcoin.in"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.ohcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xe9132d581856b5080a3936ba9e3494e984bac66b7bc2360c2a0aeab9d825cce6")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1618652902, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x10973f16191e8e3cb62eab1a9698512f7247a4f7ef7c69262f8a4bd3be55e063"));
        assert(genesis.hashMerkleRoot == uint256S("0x8040f3414db8ed4aee9bde4fb9ce56e27c63ab9f43efdbef036aaef13734963a"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x10973f16191e8e3cb62eab1a9698512f7247a4f7ef7c69262f8a4bd3be55e063"))
        };
