...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ohcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ohcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ohcoin transaction") + "\n" +
              "  ohcoin-tx [options] -create [commands]   " + _("Create hex-encoded ohcoin transaction") + "\n" +
              "\n";
