...
const char * const BITCOIN_CONF_FILENAME = "ohcoin.conf";
const char * const BITCOIN_PID_FILENAME = "ohcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "OHcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/OHcoin";
#else
    // Unix
    return pathRet / ".ohcoin";
#endif
#endif
}
